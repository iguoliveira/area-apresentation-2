        ...
        <div className="py-4 px-10 rounded-lg">
          <div className="grid grid-cols-8 mb-8 gap-10">
            ...
            <div className="col-span-7 flex flex-col justify-center items-start h-36">
              ...
              <p className="text-2xl">21 years old</p>
          ...
          <div className="h-48 py-4">
            ...
            <ul className="space-y-1 text-gray-500 list-disc list-inside">
              ...
              <li>
                ...
                Hortolandia | 2019 - 2020
              </li>
              <li>
                Analise e Desenvolvimento de Sistemas | Anhembi Morumbi | 2021 -
                Atual
              </li>
              <li>
          ...
          <div className="h-48 py-4">
            ...
            <ul className="space-y-1 text-gray-500 list-disc list-inside">
              ...
              <li>Gym</li>
              <li>Coding</li>
              <li>Role Playing Games (DnD, Tormenta, Cthulhu)</li>
              <li>Animes, Manga and Novels</li>
            </ul>
          </div>
          ...
          <div className="h-48 py-4">
            ...
            <ul className="space-y-1 text-gray-500 list-disc list-inside">
              ...
              <li>
                <strong>Nix-config</strong> - A config package for all my hosts using NixOS.
              </li>
            </ul>
          </div>
        </div>
