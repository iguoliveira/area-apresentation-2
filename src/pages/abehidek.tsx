        ...
        <div className="py-4 px-10 rounded-lg">
          <div className="grid grid-cols-8 mb-8 gap-10">
            ...
            <div className="col-span-7 flex flex-col justify-center items-start h-36">
              ...
              <div className="flex gap-3 mt-6">
                ...
                <a
                  href="https://www.linkedin.com/in/guilhermehabe"
                  target={"_blank"}
                >
                  <Image
                    width={100}
          ...
          <div className="h-48 py-4">
            ...
            <ul className="space-y-1 text-gray-500 list-disc list-inside">
              <li>
                Curso técnico em Informática | ETEC de Nova Odessa | 2018 - 2020
              </li>
              <li>
                Curso de Desenvolvimento de Sistemas | Senai Roberto Mange | 2022 - Atual
              </li>
            </ul>
          </div>
          ...
          <div className="h-48 py-4">
            ...
            <ul className="space-y-1 text-gray-500 list-disc list-inside">
              <li>Computer Science (Software development, Hardware and Infrastructure)</li>
          ...
          <div className="h-48 py-8">
            ...
            <ul className="space-y-1 text-gray-500 list-disc list-inside">
              <li>
                <strong>Bosch Einer</strong> - The ETS toolkit and Developer ecossystem, revamped.
              </li>
              <li>
